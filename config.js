...
// const DB_USER = "root";
// const DB_NAME = "CRM";
// const DB_HOST = "mysql-178158-0.cloudclusters.net";
...
const CLOUDINARY_NAME = "dxqeedmxk";
const CLOUDINARY_API_KEY = "832768668523642";
const CLOUDINARY_API_SECRET = "HhwWtJYiK6uFiFtTpQp7SK4L7HA";

//
const DIGITAL_OCEAN_BUCKET_NAME = "desktopcrm";
const DIGITAL_OCEAN_ACESS_TOKEN = "n+0i7uxykrUFd4KqW7rfRMg8HqHq7iOiMzyXUC76rUA";
const DIGITAL_OCEAN_ACESS_KEY = "DO00NHY2XYRBWHLJQYF4";
const DIGITAL_OCEAN_ORIGIN = "https://desktopcrm.nyc3.digitaloceanspaces.com";
module.exports = {
  AWS_REGION,
  S3_BUCKET,
  ...
  CLOUDINARY_NAME,
  DIGITAL_OCEAN_ACESS_TOKEN,
  DIGITAL_OCEAN_ACESS_KEY,
  DIGITAL_OCEAN_ORIGIN,
